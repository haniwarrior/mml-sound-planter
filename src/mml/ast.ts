...
export type Command = 't' | 'o' | '>' | '<' | 'l' | 'v' | '@v' | 'q' | 'p' | '@d' | '@s' | '@e' | '@lv' | '@lt' | '@f'
...
export interface Song { fmTones: Record<number,FmTone>; macros: Macros; lfos: Lfos; envelopes: Record<number, Envelope>; tracks: Record<number, Node[]> }
